  ...
  protected void initializeUniformWeight() {
    if ((problem.getNumberOfObjectives() == 2) && (populationSize <= 300)) {
      ...
      Vector<Integer> numberOfDivisions = new Vector<>(1);
		...
		ArrayList<double[]> pontos = getReferencePointsCopy(problem.getNumberOfObjectives(), numberOfDivisions);
		lambda = new double[pontos.size()][problem.getNumberOfObjectives()];
		int ii = 0;
