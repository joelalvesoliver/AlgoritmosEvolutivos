...
public class SMPSOBuilder implements AlgorithmBuilder<SMPSO> {
  ...
  public SMPSOBuilder setExecucao(int execucao) {
	  this.execucao = execucao;
	  return this;
  }
  
  public SMPSOBuilder setClassifier(String classificador)
  {
	  this.classificador = classificador;
	  return this;
  }
  
  public SMPSOBuilder setMetodo(String metodo)
  {
	  this.metodo = metodo;
	  return this;
  }
  public SMPSOBuilder setNtreino(int nTreino)
  {
  ...
  public SMPSO build() {
    if (variant.equals(SMPSOVariant.SMPSO)) {
      return new SMPSO(problem, swarmSize, leaders, mutationOperator, maxIterations, r1Min, r1Max,
          ...
          changeVelocity2, evaluator, execucao, classificador, metodo, nTreino);
    } else {
      return new SMPSOMeasures(problem, swarmSize, leaders, mutationOperator, maxIterations, r1Min, r1Max,
          r2Min, r2Max, c1Min, c1Max, c2Min, c2Max, weightMin, weightMax, changeVelocity1,
          changeVelocity2, evaluator, execucao, classificador);
    }
  }
